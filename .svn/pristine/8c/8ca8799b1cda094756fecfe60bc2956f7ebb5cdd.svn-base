...
public class Midas_OurStory1974 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1974Page() throws Exception {
		try {
			// Initialize object
			MIDAS_OurStory1974_Helper = new Midas_OurStory1974_Helper(driver);
			...
			MIDAS_OurStory1974_Helper.verifyMidasOurStory1974Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2);
			ExecutionLog.Log("Midas Training page verified successfully.");
		}
		catch (Error e) 
		{
			captureScreenshot("Midas_OurStoryPage1974");
