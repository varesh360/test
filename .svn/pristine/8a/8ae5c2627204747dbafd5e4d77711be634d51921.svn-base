...
public class VerifyB2BAdd_DeleteItemCart_Helper extends DriverHelper {
	private LocatorReader locatorReader;	
	int count=0;
	//String ExpectedResult="true"; 
	public VerifyB2BAdd_DeleteItemCart_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("VerifyB2BAdd_DeleteItemCart.xml");
	}
...
//Click on Cart option in menu
	...
	*/
	...
	//Add the Item From Cart
	try{

		String Locator=locatorReader.getLocator("ShoppingCart.EnterIteminBox");
			WaitForElementVisible(Locator,10);
				this.sendKeys(Locator, "DL154-UL");
				this.presEnterKey(Locator);
				/*
				String Locator1=locatorReader.getLocator("ShoppingCart.SelectIteminProduct");
				System.out.println(Locator1);
				this.WaitForElementPresent(Locator1, 50);
				selectDropDown(Locator1, "DL154-UL");
				*/
				//clickOn(Locator);
				String Locator2=locatorReader.getLocator("ShoppingCart.EnterProductQuantity");
				WaitForElementVisible(Locator2,10);
				this.sendKeys(Locator2, "1");
				String Locator3=locatorReader.getLocator("ShoppingCart.ClickonUpdateCarrt");
				WaitForElementVisible(Locator3,10);
				clickOn(Locator3);
...
//Verify Add Product in CArt
	try{
		String Locator=locatorReader.getLocator("ShoppingCart.VerifyAddedProduct");
		System.out.println(Locator);
		this.WaitForElementVisible(Locator,10);
		Boolean Result=this.isElementPresent(Locator);
		System.out.println("Result is"+Result);
	...
	//Click On Delete
	try{
		String Locator=locatorReader.getLocator("ShoppingCart.ClickOnDeleteProduct");
		this.WaitForElementVisible(Locator,10);
		Boolean Result=this.isElementPresent(Locator);
		System.out.println("Result is"+Result);
		String ActualResult=Result.toString();
	...
	try{
		String Locator=locatorReader.getLocator("ShoppingCart.ClickOnDeeleteLink");
		this.WaitForElementVisible(Locator,10);
		Boolean Result=this.isElementPresent(Locator);
		System.out.println("Result is"+Result);
		String ActualResult=Result.toString();
	...
	try{
		String Locator=locatorReader.getLocator("ShoppingCart.ClickonUpdateCarrt");
		this.WaitForElementVisible(Locator,10);
		Boolean Result=this.isElementPresent(Locator);
		System.out.println("Result is"+Result);
		String ActualResult=Result.toString();
	...
	//Verify Deleted Product in CArt
		try{
