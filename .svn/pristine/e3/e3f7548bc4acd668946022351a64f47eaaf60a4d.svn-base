...
public class VerifyB2B_CopyCart_Helper extends DriverHelper {
	private LocatorReader locatorReader;	
	int count=0;
	//String ExpectedResult="true"; 
	public VerifyB2B_CopyCart_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("VerifyB2B_CopyCart.xml");
	}
...
/*
	...
	*/
	...
	try{
			...
			Assert.assertTrue(driver.findElement(ByLocator(Locator)).isDisplayed(), "Place Order button not found");
...
public void VerifyOrderSuccessPage(String ExpectedResult, String ReferenceID1){
	String Order;
	try{
...
//}
	...
	try{
		System.out.println("Verify Order Success Page");
		String Locator=locatorReader.getLocator("OderSuccessFullpage.ClickOnOrders");
		this.WaitForElementVisible(Locator,50);
		clickOn(Locator);
	}catch(Exception e){
		System.out.println("Product logo not found");
	...
	try{
		System.out.println("Verify Order Success Page");
		String Locator=locatorReader.getLocator("OderSuccessFullpage.ClickOnCopyOrder");
		this.WaitForElementVisible(Locator,50);
		clickOn(Locator);
	}catch(Exception e){
		System.out.println("Product logo not found");
...
public void VerifyCheckout(String B2BUser,String password,String ExpectedResult,String ReferenceID,String ReferenceID1,String OrderType,String DeliveryMode,String DeliveryAdress){
	...
	this.VerifyOrderSuccessPage(ExpectedResult, ReferenceID1);
