...
public class Midas_OurStory2011 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory2011Page() throws Exception {
		try {
			// Initialize object
			MIDAS_OurStory2011_Helper = new Midas_OurStory2011_Helper(driver);
			...
			MIDAS_OurStory2011_Helper.verifyMidasOurStory2011Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2,CallOutBodyCopyWidth,Gutter2Width);
