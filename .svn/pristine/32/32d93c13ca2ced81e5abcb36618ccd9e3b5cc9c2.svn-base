...
public class Midas_OurStory1987 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1987Page() throws Exception {
		try {
			// Initialize object
			MIDAS_OurStory1987_Helper = new Midas_OurStory1987_Helper(driver);
			...
			MIDAS_OurStory1987_Helper.verifyMidasOurStory1987Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
