				...
				public class WhatWeDo_ZhongshanCareers_Helper extends DriverHelper {
					private LocatorReader locatorReader;	
					public WhatWeDo_ZhongshanCareers_Helper(WebDriver driver)
					{
						super(driver);
						locatorReader = new LocatorReader("WhatWeDo_ZhongshanCareers.xml");
				...
				public void VerifyWhatWeDoZhongshan(String Vspace1Height,String MaxWidth, String MaxHeight, String vSpace4height,String vTextSpace3Height, String vTextSpace7Height, String vTextSpace5Height, String TextSpace1Height, String TextSpace9Width, String vSpace8Height, String TextSpace13Height, String Gutter9Width,String ImageHeight23, String ImageWidth23, String Gutter16Width)
					...
					Assert.assertEquals(Vspace1Height, Totalpixelvaluewithpixel);
						...
						System.out.println("Zhongshan Career vSpace1Height Exception>>Expected:70px");
						count = count + 1;
					} catch (Error ex) {
						System.out.println("Zhongshan Career vSpace1Height Error>>Expected:70px");
						count = count + 1;
					}
				...
				try {
					...
					System.out.println("Zhongshan Career vSpace4height Exception>>Expected:40px");
					count = count + 1;
				} catch (Error ex) {
					System.out.println("Zhongshan Career vSpace4height Error>>Expected:40px");
					count = count + 1;
				}
				...
				Assert.assertEquals(vTextSpace3Height, Totalpixelvaluewithpixel);
					...
					System.out.println("Zhongshan Career vTextSpace3Height Exception>>Expected:17px");
					count = count + 1;
				} catch (Error ex) {
					System.out.println("Zhongshan Career vTextSpace3Height Error>>Expected:17px");
					count = count + 1;
				}
				...
				Assert.assertEquals(MaxHeight, height);
					...
					System.out.println("Zhongshan Career Height of 368px and width of 723px Exception>>Expected Height:368px and width:723px");
					count = count + 1;
				} catch (Error ex) {
					System.out.println("Zhongshan Career Height of 368px and width of 723px Error>>Expected Height:368px and width:723px");
					count = count + 1;
				}
				...
				Assert.assertEquals(vTextSpace5Height, Totalpixelvaluewithpixel);
						...
						System.out.println("Zhongshan Career vTextSpace5Height Exception>>Expected:13px");
					count = count + 1;
				} catch (Error ex) {
					System.out.println("Zhongshan Career vTextSpace5Height Exception>>Expected:13px");
					count = count + 1;
				...
				Assert.assertEquals(vTextSpace7Height, Totalpixelvaluewithpixel);
					...
					System.out.println("Zhongshan Career vTextSpace7Height Exception>>Expected:27px");
					count = count + 1;
				} catch (Error ex) {
					System.out.println("Zhongshan Career vTextSpace7Height Error>>Expected:27px");
					count = count + 1;
				}
	...
	count = count + 1;
		...
		try {
			...
			Assert.assertEquals(vSpace8Height, Totalpixelvaluewithpixel);
				...
				System.out.println("Zhongshan Career vSpace8Height Exception>>Expected:23px");
				count = count + 1;
			} catch (Error ex) {
				System.out.println("Zhongshan Career vSpace8Height Error>>Expected:23px");
				count = count + 1;
			}
try {
...
try {
	...
	Assert.assertEquals(Gutter9Width, padding_right);
		...
		System.out.println("Zhongshan Career Gutter9 Exception>>Expected:20px");
		count = count + 1;
	} catch (Error ex) {
		System.out.println("Zhongshan Career Gutter9 Error>>Expected:20px");
		count = count + 1;
	}
...
try {
	...
	Assert.assertEquals(Gutter16Width, padding_left);
		...
		System.out.println("Zhongshan Career Gutter16Width Exception>>Expected:34px");
		count = count + 1;
	} catch (Error ex) {
		System.out.println("Zhongshan Career Gutter16Width Error>>Expected:34px");
		count = count + 1;
	}
