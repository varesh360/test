/*==============================================================================================================================
 File Name    : Download_Center.java
 ClassName    : Download_Center
 Summary      : Contains automation scripts to Verify Download Center page.
 ===============================================================================================================================
...
public class Download_Center extends DriverTestCase
{
	@Test
	public void verifyDownload_CenterPage() throws Exception
	{
		...
		{
			captureScreenshot("Download_Center_Page");	
