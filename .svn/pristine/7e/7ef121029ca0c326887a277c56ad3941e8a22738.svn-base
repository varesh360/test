...
public class TurboSound_BecomePartner extends DriverTestCase 
{
	@Test
	public void VerifyBecomePartner() throws Exception {
		try {
			// Initialize object
			TURBOSOUND_Become_Helper = new TurboSound_BecomePartner_Helper(driver);
