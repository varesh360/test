...
public class Midas_OurStory2002 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory2002Page() throws Exception {
		try {
			// Initialize object
			MIDAS_OurStory2002_Helper = new Midas_OurStory2002_Helper(driver);
			...
			MIDAS_OurStory2002_Helper.verifyMidasOurStory2002Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2);
