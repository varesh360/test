...
public class Midas_OurStory1990_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public Midas_OurStory1990_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Midas_OurStory1990.xml");
	}
	...
	//Click on OurStory1970
		public void clickOurStory1970()
		{
			...
			String locator = locatorReader.getLocator("OurStory.ClickOurStory1990image");
			this.WaitForElementEnabled(locator, 100);
			clickOn(locator);
			*/
				WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[7]/a[@href='/brand/midas/ourstory/1990?active=Our story']"));
	...
	//Verify Buy Now page
	public void verifyMidasOurStory1990Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height)
	{
