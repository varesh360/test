...
public class Midas_OurStory2006 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory2006Page() throws Exception {
		try {
			// Initialize object
			MIDAS_OurStory2006_Helper = new Midas_OurStory2006_Helper(driver);
			...
			MIDAS_OurStory2006_Helper.verifyMidasOurStory2006Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2,CallOutBodyCopyWidth,Gutter2Width);
			ExecutionLog.Log("Midas Training page verified successfully.");
		}
		catch (Error e) 
		{
			captureScreenshot("Midas_OurStoryPage2006");
