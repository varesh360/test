...
public class B2B_ForgotPasswordPage_Helper extends DriverHelper {
	private LocatorReader locatorReader;

	public B2B_ForgotPasswordPage_Helper(WebDriver driver) {
		super(driver);
		locatorReader = new LocatorReader("B2B_ForgotPassword.xml");
	...
	public void verifyForgotPassword(String vSpace1Height,String TextSpace1Height,String TextSpace3Height,String Gutter16Width,String Width,String Gutter2Width,String textSpace10Height,String gap17width)
	{
		...
		try {
			...
			System.out.println("B2B gap17width Exception>>Expected :40px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("B2B gap17width Error>>Expected :40px");
			count = count + 1;
		}
	...
	/*	try {
			...
			int getaddpixel1=Integer.parseInt(margin_bottom_wopx) + Integer.parseInt(margin_top_wopx);
		    String getfinalValue=getaddpixel1+"px";
	...
	*/			
		...
		try {
			...
			String locator = locatorReader.getLocator("ForgotPassword.textSpace10Height");
			String margin_top = this.getCSS(locator, "margin-top");
