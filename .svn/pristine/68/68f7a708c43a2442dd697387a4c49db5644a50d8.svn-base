...
public class Midas_OurStory2011_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public Midas_OurStory2011_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Midas_OurStory2011.xml");
	}
