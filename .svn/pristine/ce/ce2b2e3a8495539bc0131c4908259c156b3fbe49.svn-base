...
public class Midas_OurStory1980_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public Midas_OurStory1980_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Midas_OurStory1980.xml");
	}
