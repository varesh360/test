...
public class Midas_OurStory2003_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public Midas_OurStory2003_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Midas_OurStory2003.xml");
	}
