...
public class WhatWeDo_LosAngelesCareers extends DriverTestCase 
{
	@Test
	public void VerifyWhatWeDo_LosAngeles() throws Exception {
		try {
			// Initialize object
			WHATWeDo_LosAngeles = new WhatWeDo_LosAngelesCareers_Helper(driver);
			...
			WHATWeDo_LosAngeles.VerifyWhatWeDo_LosAngelesPage(Vspace1Height,MaxWidth,MaxHeight,vSpace4height,vTextSpace3Height,vTextSpace7Height,vTextSpace5Height, TextSpace1Height,TextSpace9Width,vSpace8Height,TextSpace13Height,Gutter9Width,ImageHeight23,ImageWidth23,Gutter16Width);
