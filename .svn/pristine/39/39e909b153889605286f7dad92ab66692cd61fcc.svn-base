...
public class VerifyB2BCheckOutPage extends DriverTestCase
{
	@Test
	public void CheckoutPage() throws Exception
	{
		try{
			Checkout_Helper =new VerifyB2BCheckoutPage_Helper(driver);
ExecutionLog.LogAddClass(this.getClass().getName() + " and Test method " +Thread.currentThread().getStackTrace()[1].getMethodName());		
			...
			Checkout_Helper.VerifyCheckout(B2BUser,password,ExpectedResult, ReferenceID, OrderType,DeliveryMode,DeliveryAdress);
		}  
		catch(Error e) 
		{
