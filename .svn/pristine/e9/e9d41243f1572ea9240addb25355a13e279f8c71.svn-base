...
public class Midas_OurStory1996 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1996Page() throws Exception {
		try {
			// Initialize object
			MIDAS_OurStory1996_Helper = new Midas_OurStory1996_Helper(driver);
			...
			MIDAS_OurStory1996_Helper.verifyMidasOurStory1996Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height);
