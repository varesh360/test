...
public class Midas_OurStory1996_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public Midas_OurStory1996_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Midas_OurStory1996.xml");
	}
	...
	//Click on OurStory1970
		public void clickOurStory1970()
		{
			...
			String locator = locatorReader.getLocator("OurStory.ClickOurStory1996image");
	...
	//Verify Buy Now page
	public void verifyMidasOurStory1996Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height)
	{
