...
public class KlarkTeknik_OurStory1975_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public KlarkTeknik_OurStory1975_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("KlarkTeknik_OurStory1975.xml");
	}
	...
	public void verifyMidasOurStory1971Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2, String Gutter2Width, String CallOutBodyCopyWidth)
	{
		...
		// Verify Fixed Image Width 33 has thw width of 489px.
		try {
			String locator = locatorReader.getLocator("VerifyPixels.verifyFixedImage33");
			String margin_top = this.getCSS(locator, "width");							
			
						
			System.out.println("Actual result" + margin_top);
			Assert.assertEquals(FullWidthBoxImage33, margin_top);
			
		}

		catch (Exception ex) {
			System.out.println("KlarkTeknik OurStory 1975 Fixed Image Width Exception>>Expected Result:489px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("KlarkTeknik OurStory 1975 Fixed Image Width Exception>>Expected Result:489px");
			count = count + 1;
		...
		//Verify Fixed Image width 490px
		try {
			String locator = locatorReader.getLocator("VerifyPixels.VerifyFixedImage6");
			String margin_top = this.getCSS(locator, "width");							
		
			
						
			System.out.println("Actual result" + margin_top);
			Assert.assertEquals(FullWidthBoxImage6, margin_top);
		...
		//verify Above See All vSpace 4 has the height of 40px
