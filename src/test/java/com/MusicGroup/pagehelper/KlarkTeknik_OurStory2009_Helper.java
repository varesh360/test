...
public class KlarkTeknik_OurStory2009_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public KlarkTeknik_OurStory2009_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("KlarkTeknik_OurStory2009.xml");
	}
	...
	{
		WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[18]/a"));
	...
	public void verifyMidasOurStory2009Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2,String CallOutBodyCopyWidth, String Gutter2Width)
	{
		//Reach upto Buy Now page(MIDAS)
				...
				int Totaladdedpixel = Integer.parseInt(padding_bottom_wopx)+Integer.parseInt(margin_top_wopx)+getsubpixel- Integer.parseInt("8");
				...
				try {
					...
					String line_height = this.getCSS(locator, "padding-top");
					...
					int getsubpixel = Integer.parseInt(line_height_wopx)- Integer.parseInt("11");
			...
			//		String Totalpixelvaluewithpixel = Totaladdedpixel + "px";
					...
					System.out.println("Actual result" + padding_top1);
					Assert.assertEquals(vSpace4Height, padding_top1);
				...
				try {
					...
					int Totaladdedpixel = Integer.parseInt(padding_bottom_wopx)+Integer.parseInt(padding_top_wopx)+getsubpixel+Integer.parseInt("1");
			...
			*/
				...
				try {
					...
					int Totaladdedpixel = Integer.parseInt(margin_top_wopx)+getsubpixel+Integer.parseInt(padding_bottom_wopx)-Integer.parseInt("8");
