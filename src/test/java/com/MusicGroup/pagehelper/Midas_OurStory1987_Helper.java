...
public class Midas_OurStory1987_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public Midas_OurStory1987_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Midas_OurStory1987.xml");
	}
	...
	public void clickOurStory1970() 
	{
		...
		String locator = locatorReader.getLocator("OurStory.ClickOurStory1987image");
		this.WaitForElementEnabled(locator, 100);
		clickOn(locator);
		*/
		WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[6]/a[@href='/brand/midas/ourstory/1987?active=Our story']"));
	...
	//Verify Buy Now page
	public void verifyMidasOurStory1987Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2, String Gutter2Width, String CallOutBodyCopyWidth)
	{
