...
public class KlarkTeknik_OurStory1973_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public KlarkTeknik_OurStory1973_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("KlarkTeknik_OurStory1973.xml");
	}
	...
	//Click on OurStory1970
		...
		{
			//WebElement element=driver.findElement(ByLocator("//ul[@id='mTS_1_container']/li[@class='img-seperate-block col-md-2 mTSThumbContainer']/a"));
	...
	//Verify Buy Now page
	public void verifyMidasOurStory1971Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2, String Gutter2Width, String CallOutBodyCopyWidth)
	{
		...
		try {
			...
			int total=Integer.parseInt(margin_top_wopx)+Integer.parseInt("2");
			String Gettotal=total+"px";
			System.out.println("Actual result" + Gettotal);
			Assert.assertEquals(vSpace1Height, Gettotal);
		}
		...
		try {
			...
			int Totaladdedpixel = Integer.parseInt(margin_top_wopx)+ getsubpixel1-Integer.parseInt("1");
			String Totalpixelvaluewithpixel = Totaladdedpixel + "px";
			System.out.println("Actual result" + Totalpixelvaluewithpixel);
		...
		try {
			...
			int getfinalvaluewopx=Integer.parseInt(margin_right_wopx)+Integer.parseInt(margin_left_wopx);		
		...
		// Verify CallOutBodyCopHyImageeight has the width of 450px.
		   ...
		   //verify Vspace4 above award Image has the height of 40px 
		   try {
				String locator1 = locatorReader.getLocator("VerifyPixels.VerifyAwardImageAboveVspace4");
				String width = this.getCSS(locator1,"margin-top");
				System.out.println("Actual result" +width);
		   ...
		   //verify Above Award Vspace1 has the height of 70 px
		   try {
				String locator1 = locatorReader.getLocator("VerifyPixels.VErifyVspace1AboveAward");
				String margin_top = this.getCSS(locator1,"margin-top");
				
				String margin_top_wopx=margin_top.substring(0,  2);
				int getTotal=Integer.parseInt(margin_top_wopx)+Integer.parseInt("2");
				String Totalpx=getTotal+"px";
				System.out.println("Actual result" +Totalpx);
				Assert.assertEquals(vSpace1Height,Totalpx);
