...
public class KlarkTeknik_OurStory2000_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public KlarkTeknik_OurStory2000_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("KlarkTeknik_OurStory2000.xml");
	}
	...
	//Click on OurStory1970
		public void clickOurStory1970()
		{
			...
			WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[14]/a"));
