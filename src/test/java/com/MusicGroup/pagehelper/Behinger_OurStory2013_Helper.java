...
public class Behinger_OurStory2013_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public Behinger_OurStory2013_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Behringer_OurStory2013.xml");
	}
	...
	{
		WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[25]/a"));
	...
	//Verify Buy Now page
	public void verifyBehringer2013Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2,String CallOutBodyCopyWidth, String Gutter2Width)
	{
		...
		try {
			...
			int Totaladdedpixel = Integer.parseInt(margin_top_wopx);
		...
		try {
			...
			int getsubpixel1=Integer.parseInt(line_height_wopx1)- Integer.parseInt(font_size_wopx1)-Integer.parseInt("5");
		...
		try {
			...
			String line_height1 = this.getCSS(locator1, "margin-top");
			String font_size1 = this.getCSS(locator1, "font-size");
			...
			int getsubpixel1=Integer.parseInt(line_height_wopx1)- Integer.parseInt("26");
