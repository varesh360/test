...
public class Behringer_OurStory1977_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public Behringer_OurStory1977_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Behringer_OurStory1977.xml");
	}
