...
public class Midas_BecomePartner_helper extends DriverHelper {
	private LocatorReader locatorReader;	

	public Midas_BecomePartner_helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Midas_BecomePartner.xml");
