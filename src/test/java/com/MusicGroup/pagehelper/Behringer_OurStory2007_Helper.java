...
public class Behringer_OurStory2007_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public Behringer_OurStory2007_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Behringer_OurStory2007.xml");
	}
	...
	//Verify Buy Now page
	public void verifyBehringer2007Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2,String CallOutBodyCopyWidth, String Gutter2Width)
	{
...
*/
		...
		try {
			String locator1 = locatorReader.getLocator("VerifyPixels.vSpace1Heightaboveimage");
			String margin_top = this.getCSS(locator1, "margin-bottom");
		...
		try {
			String locator1 = locatorReader.getLocator("VerifyPixels.vSpace1Heightaboveimage1");
			String margin_top = this.getCSS(locator1, "margin-bottom");
