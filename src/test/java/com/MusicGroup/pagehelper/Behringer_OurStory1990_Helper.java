...
public class Behringer_OurStory1990_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public Behringer_OurStory1990_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Benringer_OurStory1990.xml");
	}
