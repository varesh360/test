...
public class Behringer_OurStory1992_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public Behringer_OurStory1992_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Behringer_OurStory1992.xml");
	}
