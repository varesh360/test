...
public class Behringer_OurStory1961_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public Behringer_OurStory1961_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Behringer_OurStory1961.xml");
	}
	...
	//Click on OurStory1970
		public void clickOurStory1970()
		{
			...
			WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[1]/a"));
