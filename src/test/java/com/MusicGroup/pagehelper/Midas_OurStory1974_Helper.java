...
public class Midas_OurStory1974_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public Midas_OurStory1974_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("Midas_OurStory1974.xml");
	}
	...
	//Click on OurStory1970
		...
		{ try{
			...
			//this.WaitForElementEnabled(locator, 50);
			//clickOn(locator);
			WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[3]/a"));
	...
	//Verify Buy Now page
	public void verifyMidasOurStory1974Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2)
	{
