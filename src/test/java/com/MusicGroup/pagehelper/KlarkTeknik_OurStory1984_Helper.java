...
public class KlarkTeknik_OurStory1984_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public KlarkTeknik_OurStory1984_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("KlarkTeknik_OurStory1984.xml");
	}
	...
	//Click on OurStory1970
		public void clickOurStory1970()
		{
			...
			WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[8]/a"));
