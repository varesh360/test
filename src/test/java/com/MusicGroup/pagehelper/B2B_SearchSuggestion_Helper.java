...
public class B2B_SearchSuggestion_Helper extends DriverHelper {
	private LocatorReader locatorReader;

	public B2B_SearchSuggestion_Helper(WebDriver driver) {
		super(driver);
		locatorReader = new LocatorReader("B2B_SearchSuggestionPage.xml");
	...
	
	{
		...
		String locator = locatorReader.getLocator("b2b_searchsuggestion.entertextinserachfield");
	...
	public void verifySearchSuggestion(String TextSpace4Height,String vSpace18Height,String TextSpace10Height, String Gutter17Width,String vSpace17Height,String SelectFieldWidth55Width, String SelectfieldWidth55Height, String TextSpace15Height)
	{
		...
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthList1");
		...
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthList3");
			this.WaitForElementPresent(locator, 15);
			String padding_left = this.getCSS(locator, "padding-left");
			System.out.println("Actual Result: " + padding_left);
			Assert.assertEquals(Gutter17Width,padding_left);
		...
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthList5");
			this.WaitForElementPresent(locator, 15);
			String padding_left = this.getCSS(locator, "padding-left");
			System.out.println("Actual Result: " + padding_left);
			Assert.assertEquals(Gutter17Width,padding_left);
	...
	//	-----------------------------------------------Recommended Result Iitem---------------------------------- 
		...
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthListRecommendedResult1");
			this.WaitForElementPresent(locator, 15);
			String padding_left = this.getCSS(locator, "padding-left");
			System.out.println("Actual Result: " + padding_left);
			Assert.assertEquals(Gutter17Width,padding_left);
...
//		-----------------------------------------Common Searches---------------------------------- 
		...
		// Verify Gutter17Width has the width of 10px (First) .
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthListCommonSearch1");
			this.WaitForElementPresent(locator, 15);
			String padding_left = this.getCSS(locator, "padding-left");
			System.out.println("Actual Result: " + padding_left);
			Assert.assertEquals(Gutter17Width,padding_left);
		...
		// Verify Gutter17Width has the width of 10px Third .
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthListCommonSearch3");
			this.WaitForElementPresent(locator, 15);
			String padding_right = this.getCSS(locator, "padding-right");
			System.out.println("Actual Result: " + padding_right);
			Assert.assertEquals(Gutter17Width,padding_right);
		...
		// Verify SelectedField55Width has the width of 238px  .
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.SelectedField55");
			this.WaitForElementPresent(locator, 15);
		...
		// Verify SelectedField55Width has the height of 25px  .
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.SelectedField55");
			this.WaitForElementPresent(locator, 15);
			String height = this.getCSS(locator, "height");
			System.out.println("Actual Result: " + height);
			Assert.assertEquals(SelectfieldWidth55Height,height);
		}

		catch (Exception ex) {
			System.out.println("B2B Serach Suggestion SelectfieldWidth55Height Exception>>Expected Pading Top:25px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("B2B Serach Suggestion SelectfieldWidth55Height Error>>Expected Padding:25px");
			count = count + 1;
		}
		...
		try {
			...
			String locator1 = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthList2");
			...
			int getaddpixel = Integer.parseInt(padding_top_wopx)+ Integer.parseInt(padding_bottom_wopx);
		...
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthList2");
			this.WaitForElementPresent(locator, 15);
			String padding_bottom = this.getCSS(locator, "padding-bottom");
			String padding_bottom_wopx = padding_bottom.substring(0, 1);
			String locator1 = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthList3");
			this.WaitForElementPresent(locator1, 15);
			String padding_top = this.getCSS(locator1, "padding-top");
			String padding_top_wopx = padding_top.substring(0, 1);
			int getaddpixel = Integer.parseInt(padding_top_wopx)+ Integer.parseInt(padding_bottom_wopx);
		...
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthList4");
			this.WaitForElementPresent(locator, 15);
			String padding_bottom = this.getCSS(locator, "padding-bottom");
			String padding_bottom_wopx = padding_bottom.substring(0, 1);
			String locator1 = locatorReader.getLocator("b2b_searchsuggestion.Gutter17WidthList5");
			this.WaitForElementPresent(locator1, 15);
			String padding_top = this.getCSS(locator1, "padding-top");
			String padding_top_wopx = padding_top.substring(0, 1);
			int getaddpixel = Integer.parseInt(padding_top_wopx)+ Integer.parseInt(padding_bottom_wopx);
		...
		try {
			...
			int getaddpixel = getsubpixel1+getsubpixel+Integer.parseInt(padding_bottom_wopx)+Integer.parseInt(padding_top_wopx1)-Integer.parseInt("2");
			String getfinalValue=getaddpixel+"px";
			System.out.println("Actual Result: " + getfinalValue);
		...
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.TextSpace10Height");
			this.WaitForElementPresent(locator, 15);
			...
			int getsubpixel1 = Integer.parseInt(line_height_wopx1)- Integer.parseInt(font_size_wopx1);
			int getaddpixel = getsubpixel1+Integer.parseInt(padding_top_wopx)+Integer.parseInt(padding_bottom_wopx1)+Integer.parseInt("1");
			String getfinalValue=getaddpixel+"px";
			System.out.println("Actual Result: " + getfinalValue);
			...
			System.out.println("B2B Serach Suggestion TextSpace10Height Error>>Expected Padding:16px");
			count = count + 1;
		}	
		...
		// Verify vSpace18Height has the height of 8px
		try {
			String locator = locatorReader.getLocator("b2b_searchsuggestion.vSpace18Heightlast");
			this.WaitForElementPresent(locator, 15);
			...
			int getfirstfincalvalue=Integer.parseInt(margin_top_wopx)+getsubpixel1-Integer.parseInt("1");
			String getfinalValue=getfirstfincalvalue+"px";
			System.out.println("Actual result:    "+getfinalValue);
			Assert.assertEquals(vSpace18Height,getfinalValue);
			...
			System.out.println("B2B Serach Suggestion vSpace18Height Exception>>Expected Result:8px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("B2B Serach Suggestion vSpace18Height Error>>Expected Result:8px");
			count = count + 1;
		}				
