...
public class KlarkTeknik_OurStory1990_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public KlarkTeknik_OurStory1990_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("KlarkTeknik_OurStory1990.xml");
	}
	...
	//Click on OurStory1970
		...
		{
			//WebElement element=driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[5]/a"));
			//((JavascriptExecutor)driver).executeScript("argument[0].click();", element);
			WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[11]/a"));
	...
	public void verifyMidasOurStory1971Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2, String Gutter2Width, String CallOutBodyCopyWidth)
	{
		...
		try {
			...
			int gettotal=getsubpixel+Integer.parseInt("5");
			String Totalpixelvaluewithpixel = gettotal + "px";
			System.out.println("Actual result" + Totalpixelvaluewithpixel);
