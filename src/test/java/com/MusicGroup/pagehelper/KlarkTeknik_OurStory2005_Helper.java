...
public class KlarkTeknik_OurStory2005_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public KlarkTeknik_OurStory2005_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("KlarkTeknik_OurStory2005.xml");
	}
	...
	//Click on OurStory1970
		public void clickOurStory1970()
		{
			...
			WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[17]/a"));
	...
	public void verifyMidasOurStory1971Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2, String Gutter2Width, String CallOutBodyCopyWidth)
	{
		...
		try {
			...
			int totalCount=Integer.parseInt(margin_top_wopx)+Integer.parseInt("2");
			String getTotalpx=totalCount+"px";
		...
		int Totaladdedpixel = Integer.parseInt(margin_bottom_wopx)+Integer.parseInt(margin_top_wopx)+Integer.parseInt("1");
