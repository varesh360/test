...
public class KlarkTeknik_OurStory2014_Helper extends DriverHelper
{
	private LocatorReader locatorReader;	

	public KlarkTeknik_OurStory2014_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("KlarkTeknik_OurStory2014.xml");
	}
	...
	{
		WebElement element = driver.findElement(ByLocator("//ul[@id='mTS_1_container']//li[20]/a"));
	...
	//Verify Buy Now page
	public void verifyMidasOurStory2011Page(String vSpace1Height, String TextSpace8Height, String TextSpace6Height, String vSpace4Height, String Gutter16Width, String FullWidthBoxImage33, String FullWidthBoxImage6, String BodayCopyLeadingHeight,String FullWidthBoxImage, String vSpace2Height, String TextSpace1Height, String ImageWidth2,String CallOutBodyCopyWidth, String Gutter2Width)
	{
		...
		int Totaladdedpixel = Integer.parseInt(margin_bottom_wopx)+Integer.parseInt(margin_top_wopx)+getpixel-Integer.parseInt("8");
		...
		try {
			...
			int Totaladdedpixel = getsubpixel+getsubpixel-Integer.parseInt("6")+Integer.parseInt(margin_bottom_wopx);
			String Totalpixelvaluewithpixel = Totaladdedpixel + "px";
			System.out.println("Actual result" + Totalpixelvaluewithpixel);
			Assert.assertEquals(TextSpace6Height, Totalpixelvaluewithpixel);
		...
		try {
			...
			int Totaladdedpixel = Integer.parseInt(padding_bottom_wopx)+getsubpixel+Integer.parseInt("1");
			String Totalpixelvaluewithpixel = Totaladdedpixel + "px";
			System.out.println("Actual result" + Totalpixelvaluewithpixel);
