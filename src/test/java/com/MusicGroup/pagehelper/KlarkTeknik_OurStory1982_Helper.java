...
public class KlarkTeknik_OurStory1982_Helper extends DriverHelper

{
	private LocatorReader locatorReader;	

	public KlarkTeknik_OurStory1982_Helper(WebDriver driver)
	{
		super(driver);
		locatorReader = new LocatorReader("KlarkTeknik_OurStory1982.xml");
	}
