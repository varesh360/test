		...
		public class WhatWeDo_LosAngelesCareers_Helper extends DriverHelper {
			private LocatorReader locatorReader;	
			public WhatWeDo_LosAngelesCareers_Helper(WebDriver driver)
			{
				super(driver);
				locatorReader = new LocatorReader("WhatWeDo_LosAngelesCareers.xml");
		...
		Assert.assertEquals(Vspace1Height, Totalpixelvaluewithpixel);
			...
			System.out.println("Los Angeles Career vSpace1Height Exception>>Expected:70px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("Los Angeles Career vSpace1Height Error>>Expected:70px");
			count = count + 1;
		}
		...
		Assert.assertEquals(vSpace4height, Totalpixelvaluewithpixel);
			...
			System.out.println("Los Angeles Career vSpace4height Exception>>Expected:40px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("Los Angeles Career vSpace4height Error>>Expected:40px");
			count = count + 1;
		}
		...
		Assert.assertEquals(vTextSpace3Height, Totalpixelvaluewithpixel);
			...
			System.out.println("Los Angeles Career vTextSpace3Height Exception>>Expected:17px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("Los Angeles Career vTextSpace3Height Error>>Expected:17px");
			count = count + 1;
		}
		...
		Assert.assertEquals(MaxHeight, height);
			...
			System.out.println("Los Angeles Career Height of 368px and width of 723px Exception>>Expected:Height:368px and width:723px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("Los Angeles Career Height of 368px and width of 723px Error>>Expected: 368px and width:723px");
			count = count + 1;
		}
		...
		Assert.assertEquals(vTextSpace5Height, Totalpixelvaluewithpixel);
				...
				System.out.println("Los Angeles Career vTextSpace5Height Exception>>Expected:13px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("Los Angeles Career vTextSpace5Height Error>>Expected:13px");
			count = count + 1;
		}
		...
		Assert.assertEquals(vTextSpace7Height, Totalpixelvaluewithpixel);
			...
			System.out.println("Los Angeles Career vTextSpace7Height Exception>>Expected:27px");
			count = count + 1;
		} catch (Error ex) {
			System.out.println("Los Angeles Career vTextSpace7Height Error>>Expected:27px");
			count = count + 1;
		}
		...
		System.out.println("Los Angeles Career vSpace8Height Exception>>Expected:23px");
		count = count + 1;
		} catch (Error ex) {
		System.out.println("Los Angeles Career vSpace8Height Expection>>Expected:23px");
		count = count + 1;
		}
		try {
		...
		System.out.println("Los Angeles Career vSpace1Height Exception>>Expected Margin Top:70px");
		count = count + 1;
		} catch (Error ex) {
		System.out.println("Los Angeles Career vSpace1Height Error>>Expected Width:70px");
		count = count + 1;
		}
		*/
		...
		System.out.println("Los Angeles Career Gutter9Width Exception>>Expected:20px");
		count = count + 1;
		} catch (Error ex) {
		System.out.println("Los Angeles Career Gutter9Width Error>>Expected:20px");
		count = count + 1;
		}
		...
		System.out.println("Los Angeles Career Gutter16Width Exception>>Expected:34px");
		count = count + 1;
		} catch (Error ex) {
		System.out.println("Los Angeles Career Gutter16Width Error>>Expected Width:34px");
		count = count + 1;
		}
