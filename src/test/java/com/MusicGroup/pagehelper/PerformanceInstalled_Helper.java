...
public class PerformanceInstalled_Helper extends DriverHelper {
	private LocatorReader locatorReader;

	public PerformanceInstalled_Helper(WebDriver driver) {
		super(driver);
		locatorReader = new LocatorReader("PerformanceInstalled.xml");
	...
	public void verifyProductionHomepage(String HomeBillboardWidth,String HomeBillboardHeight,String LineDivider,String SpotLightImageWidth,String SpotLightImageHeight, String SpotLightImageWidth_1)
	{
		...
		// Verify HomeBillboard has the width of 1446px .
				...
				try {
					...
					String border_top_width = this.getCSS(locator, "padding-top");
				...
				try {
					...
					String border_right_width = this.getCSS(locator, "padding-right");
			...
			// Verify SpotLightImage has the height of 200px(First Image)
				...
				try {
					...
					Assert.assertEquals(SpotLightImageWidth_1,GetWidth);
