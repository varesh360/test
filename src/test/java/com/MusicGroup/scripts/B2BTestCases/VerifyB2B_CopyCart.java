...
public class VerifyB2B_CopyCart extends DriverTestCase
{
	@Test
	public void CheckoutPage() throws Exception
	{
		try{
			CopyCart_Helper =new VerifyB2B_CopyCart_Helper(driver);
ExecutionLog.LogAddClass(this.getClass().getName() + " and Test method " +Thread.currentThread().getStackTrace()[1].getMethodName());		
			...
			//String ReferenceID= Integer.toString(id);
			...
			String ReferenceID1=getRandomInteger()+"00";
			System.out.println("new ref id: " +ReferenceID1);
			CopyCart_Helper.VerifyCheckout(B2BUser,password,ExpectedResult, ReferenceID, ReferenceID1, OrderType,DeliveryMode,DeliveryAdress);
		}  
		catch(Error e) 
		{
