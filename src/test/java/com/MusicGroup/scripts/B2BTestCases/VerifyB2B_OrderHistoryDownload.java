...
public class VerifyB2B_OrderHistoryDownload extends DriverTestCase
{
	@Test
	public void CheckoutPage() throws Exception
	{
		try{
			DownloadOrder_Helper =new VerifyB2B_OrderHistoryDownload_Helper(driver);
ExecutionLog.LogAddClass(this.getClass().getName() + " and Test method " +Thread.currentThread().getStackTrace()[1].getMethodName());		
			...
			DownloadOrder_Helper.VerifyCheckout(B2BUser,password,ExpectedResult, ReferenceID, OrderType,DeliveryMode,DeliveryAdress);
		}  
		catch(Error e) 
		{
