...
public class VerifyB2B_OrderHistoryUpdate extends DriverTestCase
{
	@Test
	public void CheckoutPage() throws Exception
	{
		try{
			OrderHistoryUpdate_Helper =new VerifyB2B_OrderHistoryUpdate_Helper(driver);
ExecutionLog.LogAddClass(this.getClass().getName() + " and Test method " +Thread.currentThread().getStackTrace()[1].getMethodName());		
			...
			OrderHistoryUpdate_Helper.VerifyCheckout(B2BUser,password,ExpectedResult, ReferenceID, OrderType,DeliveryMode,DeliveryAdress);
		}  
		catch(Error e) 
		{
