...
public class VerifyB2BAdd_DeleteItemCart extends DriverTestCase
{
	@Test
	public void CheckoutPage() throws Exception
	{
		try{
			Add_DeleteItem_Helper =new VerifyB2BAdd_DeleteItemCart_Helper(driver);
ExecutionLog.LogAddClass(this.getClass().getName() + " and Test method " +Thread.currentThread().getStackTrace()[1].getMethodName());		
			...
			Add_DeleteItem_Helper.VerifyCheckout(B2BUser,password,ExpectedResult, ReferenceID, OrderType,DeliveryMode,DeliveryAdress);
		}  
		catch(Error e) 
		{
