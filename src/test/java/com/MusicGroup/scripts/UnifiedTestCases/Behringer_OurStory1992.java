...
import test.java.com.MusicGroup.pagehelper.Behringer_OurStory1992_Helper;
public class Behringer_OurStory1992 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			// Initialize object
			Behringer_OURStory1992_Helper = new Behringer_OurStory1992_Helper(driver);
			...
			Behringer_OURStory1992_Helper.verifyMidasOurStory1971Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
