...
import test.java.com.MusicGroup.pagehelper.Behringer_OurStory2011_Helper;

public class Behringer_OurStory2011 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			...
			Behringer_OURStory2011_Helper = new Behringer_OurStory2011_Helper(driver);
			...
			Behringer_OURStory2011_Helper.verifyBehringer2011Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
