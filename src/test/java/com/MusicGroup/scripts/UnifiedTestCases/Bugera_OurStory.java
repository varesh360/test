...
import test.java.com.MusicGroup.pagehelper.Bugera_OurStory_Helper;
public class Bugera_OurStory extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			// Initialize object
			Bugera_OURSTORY_Helper = new Bugera_OurStory_Helper(driver);
			...
			Bugera_OURSTORY_Helper.verifyBehringer2013Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
