...
import test.java.com.MusicGroup.pagehelper.TurboSound_OurStory1986_Helper;
public class TurboSound_OurStory1986 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory2003Page() throws Exception {
		try {
			// Initialize object
			TS_OurStory1986_Helper = new TurboSound_OurStory1986_Helper(driver);
			...
			TS_OurStory1986_Helper.verifyMidasOurStory1980Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
