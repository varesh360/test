...
import test.java.com.MusicGroup.pagehelper.Behringer_OurStory2012_Helper;
public class Behringer_OurStory2012 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			 //Initialize object 
			 Behringer_OURStory2012_Helper = new Behringer_OurStory2012_Helper(driver);
			 ExecutionLog.LogAddClass(this.getClass().getName()+ " and Test method "+ Thread.currentThread().getStackTrace()[1].getMethodName());
				...
				Behringer_OURStory2012_Helper.verifyBehringer2012Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
