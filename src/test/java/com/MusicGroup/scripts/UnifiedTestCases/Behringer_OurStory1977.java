...
import test.java.com.MusicGroup.pagehelper.Behringer_OurStory1977_Helper;
public class Behringer_OurStory1977 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			// Initialize object
			Behringer_OURStory1977_Helper = new Behringer_OurStory1977_Helper(driver);
			...
			Behringer_OURStory1977_Helper.verifyMidasOurStory1971Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
