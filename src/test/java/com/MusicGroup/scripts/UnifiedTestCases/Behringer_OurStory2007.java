...
import test.java.com.MusicGroup.pagehelper.Behringer_OurStory2007_Helper;
public class Behringer_OurStory2007 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			...
			Behringer_OURStory2007_Helper = new Behringer_OurStory2007_Helper(driver);
			...
			Behringer_OURStory2007_Helper.verifyBehringer2007Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
