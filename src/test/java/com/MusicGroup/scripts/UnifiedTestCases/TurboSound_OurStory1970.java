...
import test.java.com.MusicGroup.pagehelper.TurboSound_OurStory1970_Helper;
public class TurboSound_OurStory1970 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory2003Page() throws Exception {
		try {
			// Initialize object
			TS_OurStory1970_Helper = new TurboSound_OurStory1970_Helper(driver);
			...
			TS_OurStory1970_Helper.verifyMidasOurStory2003Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2);
