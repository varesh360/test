...
import test.java.com.MusicGroup.pagehelper.Behringer_OurStory2009_Helper;
public class Behringer_OurStory2009 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			...
			Behringer_OURStory2009_Helper = new Behringer_OurStory2009_Helper(driver);
			...
			Behringer_OURStory2009_Helper.verifyBehringer2009Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
