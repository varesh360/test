...
import test.java.com.MusicGroup.pagehelper.KlarkTeknik_OurStory2014_Helper;
public class KlarkTeknik_OurStory2014 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory2011Page() throws Exception {
		try {
			// Initialize object
			KlarkTeknik_OURStory2014_Helper = new KlarkTeknik_OurStory2014_Helper(driver);
			...
			KlarkTeknik_OURStory2014_Helper.verifyMidasOurStory2011Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2,CallOutBodyCopyWidth,Gutter2Width);
