...
public class Midas_BecomePartner extends DriverTestCase 
{
	@Test
	public void VerifyBecomePartner() throws Exception {
		try {
			// Initialize object
			MIDAS_Become_Helper = new Midas_BecomePartner_helper(driver);
