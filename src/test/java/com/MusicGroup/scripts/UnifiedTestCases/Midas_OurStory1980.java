...
public class Midas_OurStory1980 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1974Page() throws Exception {
		try {
			// Initialize object
			MIDAS_OurStory1980_Helper = new Midas_OurStory1980_Helper(driver);
			...
			MIDAS_OurStory1980_Helper.verifyMidasOurStory1980Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
