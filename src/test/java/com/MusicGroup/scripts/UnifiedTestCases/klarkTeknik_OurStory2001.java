...
import test.java.com.MusicGroup.pagehelper.KlarkTeknik_OurStory2001_Helper;
public class klarkTeknik_OurStory2001 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			// Initialize object
			KlarkTeknik_OURStory2001_Helper = new KlarkTeknik_OurStory2001_Helper(driver);
			...
			KlarkTeknik_OURStory2001_Helper.verifyMidasOurStory1971Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
