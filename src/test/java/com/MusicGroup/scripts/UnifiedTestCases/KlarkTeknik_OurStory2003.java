...
import test.java.com.MusicGroup.pagehelper.KlarkTeknik_OurStory2003_Helper;
public class KlarkTeknik_OurStory2003 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			// Initialize object
			KlarkTeknik_OURStory2003_Helper = new KlarkTeknik_OurStory2003_Helper(driver);
			...
			KlarkTeknik_OURStory2003_Helper.verifyMidasOurStory1971Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
