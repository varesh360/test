...
public class Midas_OurStory1986 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1986Page() throws Exception {
		try {
			// Initialize object
			MIDAS_OurStory1986_Helper = new Midas_OurStory1986_Helper(driver);
			...
			MIDAS_OurStory1986_Helper.verifyMidasOurStory1986Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
			ExecutionLog.Log("Midas Training page verified successfully.");
		}
		catch (Error e) 
		{
			captureScreenshot("Midas_OurStoryPage1980");
