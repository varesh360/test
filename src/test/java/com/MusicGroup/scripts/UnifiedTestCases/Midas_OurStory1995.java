...
public class Midas_OurStory1995 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1990Page() throws Exception {
		try {
			// Initialize object
			MIDAS_OurStory1995_Helper = new Midas_OurStory1995_Helper(driver);
			...
			MIDAS_OurStory1995_Helper.verifyMidasOurStory1995Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height);
			ExecutionLog.Log("Midas Training page verified successfully.");
		}
		catch (Error e) 
		{
			captureScreenshot("Midas_OurStoryPage1995");
