...
import test.java.com.MusicGroup.pagehelper.Behinger_OurStory2013_Helper;

public class Behringer_OurStory2013 extends DriverTestCase 
{
	@Test
	public void verifyMidas_OurStory1971Page() throws Exception {
		try {
			...
			Behringer_OURStory2013_Helper = new Behinger_OurStory2013_Helper(driver);
			...
			Behringer_OURStory2013_Helper.verifyBehringer2013Page(vSpace1Height,TextSpace8Height,TextSpace6Height,vSpace4Height,Gutter16Width,FullWidthBoxImage33,FullWidthBoxImage6,BodayCopyLeadingHeight,FullWidthBoxImage,vSpace2Height,TextSpace1Height,ImageWidth2, Gutter2Width,CallOutBodyCopyWidth);
