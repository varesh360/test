...
public class WhatWeDo_LasVegasCareers extends DriverTestCase 
{
	@Test
	public void VerifyWhatWeDo_LasVegas() throws Exception {
		try {
			// Initialize object
			WHATWeDo_LasVegas = new WhatWeDo_LasVegasCareers_Helper(driver);
			...
			WHATWeDo_LasVegas.VerifyWhatWeDo_LasVegasPage(Vspace1Height,MaxWidth,MaxHeight,vSpace4height,vTextSpace3Height,vTextSpace7Height,vTextSpace5Height, TextSpace1Height,TextSpace9Width,vSpace8Height,TextSpace13Height,Gutter9Width,ImageHeight23,ImageWidth23,Gutter16Width);
